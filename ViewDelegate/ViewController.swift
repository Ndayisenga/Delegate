...
//  ViewDelegate
//
//  Created by Ndayisenga Jean Claude on 24/04/2021.
//
...
class ViewController: UIViewController, NotificationSettingViewDelegate {
    ...
    func didTapEnableButton() {
        let alert = UIAlertController(title: "Enable Notifications", message: "some longer message here to tell user to do stuff.", preferredStyle: .alert)
 ...
 class NotificationSettingView: UIView {
    ...
    private let label: UILabel = {
        let label = UILabel()
        label.text = "To Stay Up-To-Date enable Push Notificationds!"
